...
export const tabVariants: Record<TabsVariant, string> = {
  underline:
    "border-b-2 border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300 data-[active=true]:border-primary-500 data-[active=true]:text-primary-600",
