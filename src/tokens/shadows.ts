...
export const shadows = {
  ...
  md: "0 2px 6px 0px rgba(0, 0, 0, 0.1), 0 2px 4px -2px rgba(0, 0, 0, 0.1)",
  /** Elevated shadow for modals, floating elements */
  lg: "0 5px 15px -2px rgba(0, 0, 0, 0.1), 0 4px 6px -4px rgba(0, 0, 0, 0.1)",
  /** Highest elevation for toasts, tooltips */
  xl: "0 10px 25px -4px rgba(0, 0, 0, 0.1), 0 8px 10px -6px rgba(0, 0, 0, 0.1)",
